   ...
   @objc func loadData() {
    ...
    func loadTableView() {
        DispatchQueue.main.async
        {
            ...
            self.chatTableView.register(UINib(nibName: "ChatCell", bundle: .main), forCellReuseIdentifier: "ChatCell")
            self.chatTableView.rowHeight = 50
    ...
    func sendNewMessageNotification(msg:String) {
        ...
        sender.sendPushNotification(to: receiverName!, title: String(format:"New Message from %@", Utilities.currentUserName()), body: msg)
    }
    deinit {
